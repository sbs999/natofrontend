    ...
    <div>
      ...
      <div className="flex max-w-[300px] mx-auto rounded-[10px] justify-between mt-[20px] ">
        <div
          ...
          className={`w-[50%] ${
            state === "list" ? "bg-green-500" : "bg-red-500"
          } text-white grid place-content-center text-center rounded-[10px] cursor-pointer`}
        >
          ისტორიიდან დამატება
        </div>
        <div
          ...
          className={`w-[50%] ${
            state === "new" ? "bg-green-500" : "bg-red-500"
          } text-white grid place-content-center rounded-[10px] cursor-pointer`}
        >
          ახლის დამატება
        </div>
      </div>
