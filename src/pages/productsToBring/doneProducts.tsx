...
export const DoneProducts = () => {
  ...
  const { doneProducts } = useAppSelector((state) => state.products);
  ...
  useEffect(() => {
    dispatch(getProducts({ productStatus: ProductStatuses.BROUGHT }));
  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        ...
        <p className="mr-2">მოტანილი პროდუქტები</p>
      </div>

      <ProductList
        productStatus={ProductStatuses.BROUGHT}
