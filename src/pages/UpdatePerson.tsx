...
const UpdatePerson = () => {
  ...
  const [state, setState] = useState(
    persons.filter((p) => p._id.toString() === personId)
  );
            ...
            >
              <Form>
                ...
                <Input
                  ...
                  id="personInfo"
                  type="text"
                  placeholder="ინფორმაცია ადამიანზე"
                />
                <Input
                  label="თანხა"
                  name="money"
                ...
                />
                <Input
                  label="ინფორმაცია განახლებაზე"
                  name="updateInfo"
                  id="updateInfo"
                  type="text"
                  placeholder="ინფორმაცია განახლებაზე"
                />
